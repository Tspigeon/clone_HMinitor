<template>
    <div>
        <div ref="chart" style="height:260px" @click="toPeople"></div>
        <img src="../../../public/img/bg3.png" alt="" id="bg_img" style="display:none">
        <!-- <img src="../../../public/img/round1" alt="" style="display:none" ref="round1"> -->
    </div>
</template>
